                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php $numeroFormateado = number_format($dato->valor, 0) ?>
                                <td><?php echo "$ ".$numeroFormateado; ?></td>
            ...
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar.php">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="txtDescripcion" rows="10" class="form-control" autofocus required></textarea>
                    </div>
                    <div class="mb-5">
